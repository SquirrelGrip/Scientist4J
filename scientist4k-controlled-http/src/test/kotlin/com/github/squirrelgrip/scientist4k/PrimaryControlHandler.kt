...
class PrimaryControlHandler : AbstractHandler() {
    companion object {
        ...
        private val LOGGER: Logger = LoggerFactory.getLogger(PrimaryControlHandler::class.java)
    }
...
fun main() {
    val server = SecuredServer(PrimaryControlHandler.serverConfiguration, CandidateHandler())
    server.start()
    server.join()
}